// Generated from /Users/mckinnec/github/fa2024-595-step7-cbpmckinney/python/MicroC.g4 by ANTLR 4.13.1
...
public class MicroCParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, IDENTIFIER=35, INT_LITERAL=36, FLOAT_LITERAL=37, 
		STR_LITERAL=38, COMMENT=39, WS=40;
	public static final int
		RULE_program = 0, RULE_decls = 1, RULE_var_decls = 2, RULE_ident = 3, 
		RULE_var_decl = 4, RULE_str_decl = 5, RULE_my_type = 6, RULE_base_type = 7, 
		...
		RULE_arg_list = 32, RULE_args_rest = 33, RULE_cast_expr = 34, RULE_expr = 35, 
		RULE_term = 36, RULE_cond = 37, RULE_cmpop = 38, RULE_mulop = 39, RULE_addop = 40, 
		RULE_shiftop = 41;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "decls", "var_decls", "ident", "var_decl", "str_decl", "my_type", 
			...
			"call_expr", "arg_list", "args_rest", "cast_expr", "expr", "term", "cond", 
			"cmpop", "mulop", "addop", "shiftop"
		};
	}
	...
	public static class Var_declContext extends ParserRuleContext {
		public My_typeContext my_type;
		public IdentContext ident;
		public My_typeContext my_type() {
			return getRuleContext(My_typeContext.class,0);
		}
		public IdentContext ident() {
	...
	public final Var_declContext var_decl() throws RecognitionException {
		...
		try {
			...
			{
			setState(108);
			((Var_declContext)_localctx).my_type = my_type(0);
			setState(109);
			((Var_declContext)_localctx).ident = ident();
			setState(110);
			match(T__0);
			self.st.addVariable(((Var_declContext)_localctx).my_type.t, (((Var_declContext)_localctx).ident!=null?_input.getText(((Var_declContext)_localctx).ident.start,((Var_declContext)_localctx).ident.stop):null));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	@SuppressWarnings("CheckReturnValue")
	public static class My_typeContext extends ParserRuleContext {
		public Scope.Type t;
		public My_typeContext t1;
		...
		public My_typeContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_my_type; }
	}

	public final My_typeContext my_type() throws RecognitionException {
		return my_type(0);
	}

	private My_typeContext my_type(int _p) throws RecognitionException {
		ParserRuleContext _parentctx = _ctx;
		int _parentState = getState();
		My_typeContext _localctx = new My_typeContext(_ctx, _parentState);
		My_typeContext _prevctx = _localctx;
		int _startState = 12;
		enterRecursionRule(_localctx, 12, RULE_my_type, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(121);
			((My_typeContext)_localctx).base_type = base_type();
			((My_typeContext)_localctx).t =  ((My_typeContext)_localctx).base_type.t;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					{
					{
					_localctx = new My_typeContext(_parentctx, _parentState);
					_localctx.t1 = _prevctx;
					pushNewRecursionContext(_localctx, _startState, RULE_my_type);
					setState(124);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(125);
					match(T__3);
					((My_typeContext)_localctx).t =  Scope.Type.pointerToType(((My_typeContext)_localctx).t1.t);
					}
					} 
				}
				setState(131);
	...
	public final Func_typeContext func_type() throws RecognitionException {
		...
		try {
			...
			case T__5:
				...
				{
				setState(138);
				((Func_typeContext)_localctx).my_type = my_type(0);
				((Func_typeContext)_localctx).t =  ((Func_typeContext)_localctx).my_type.t;
				}
				break;
			case T__6:
				enterOuterAlt(_localctx, 2);
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			{
			setState(187);
			((ParamContext)_localctx).my_type = my_type(0);
			setState(188);
			...
			((ParamContext)_localctx).param_type =  ((ParamContext)_localctx).my_type.t;
	...
	public final Cast_exprContext cast_expr() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_cast_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(401);
			match(T__7);
			setState(402);
			((Cast_exprContext)_localctx).my_type = my_type(0);
			setState(403);
			match(T__8);
			setState(404);
			((Cast_exprContext)_localctx).primary = primary();
			((Cast_exprContext)_localctx).node = CastNode(((Cast_exprContext)_localctx).my_type.t, ((Cast_exprContext)_localctx).primary.node);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(412);
						((ExprContext)_localctx).shiftop = shiftop();
						setState(413);
						((ExprContext)_localctx).il = match(INT_LITERAL);
						((ExprContext)_localctx).node =  ShiftNode(((ExprContext)_localctx).e1.node, (((ExprContext)_localctx).il!=null?((ExprContext)_localctx).il.getText():null), (((ExprContext)_localctx).shiftop!=null?_input.getText(((ExprContext)_localctx).shiftop.start,((ExprContext)_localctx).shiftop.stop):null));
						}
						break;
					case 2:
						{
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 6:
			return my_type_sempred((My_typeContext)_localctx, predIndex);
		case 30:
	...
	private boolean my_type_sempred(My_typeContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
