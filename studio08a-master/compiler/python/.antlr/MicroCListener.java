...
public interface MicroCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroCParser#my_type}.
	 * @param ctx the parse tree
	 */
	void enterMy_type(MicroCParser.My_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroCParser#my_type}.
	 * @param ctx the parse tree
	 */
	void exitMy_type(MicroCParser.My_typeContext ctx);
	/**
